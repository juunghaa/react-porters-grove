...
![홈 대시보드](assets/screenshots/grove_home.png)
...
![새로 만들기](assets/screenshots/grove_new.png)

![카테고리 선택](assets/screenshots/grove_category.png)
...
![경험 등록 폼](assets/screenshots/grove_form.png)

> Situation(상황) → Task(과제) → Action(행동) → Result(결과) 구조로 경험을 체계적으로 기록

![STAR 기법 작성](assets/screenshots/grove_star.png)
...
![포트폴리오 경험 선택](assets/screenshots/grove_portfolio_step1.png)

**2단계: 키워드 선택**
> 나를 나타내는 키워드 3가지를 선택해 포트폴리오의 방향 설정

![키워드 선택](assets/screenshots/grove_portfolio_step2.png)

**3단계: 자기소개 작성**
> 나는 어떤 사람인지, 가장 큰 강점과 성장 방향을 작성

![자기소개 작성](assets/screenshots/grove_portfolio_step3.png)

**완성 — PDF 저장**
> 포트폴리오 완성 후 PDF로 저장하거나 아카이브에 보관

![포트폴리오 완성](assets/screenshots/grove_portfolio_done.png)
...
![아카이브 경험](assets/screenshots/grove_archive.png)

![아카이브 스펙·포트폴리오](assets/screenshots/grove_archive2.png)
