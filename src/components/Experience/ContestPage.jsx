          ...
          <div className="contest-main-content">
            <div className="contest-form-container">
              ...
              <div className="form-field-frame">
                ...
                <input type="text" name="title" className="form-input" placeholder="참여한 공모전명의 이름을 입력하세요" value={formData.title} onChange={handleInputChange} />
              </div>

              <div className="form-row">
                <div className="form-field-frame field-topic">
                  <label className="form-field-label">주제</label>
                  <input type="text" name="subject" className="form-input" placeholder="제안하거나 개발한 아이디어의 주제를 적어주세요" value={formData.subject} onChange={handleInputChange} />
                </div>
                <div className="form-field-frame field-organizer">
                  <label className="form-field-label">주최 기관</label>
                  <input type="text" name="organization" className="form-input" placeholder="주최 기관을 입력하세요" value={formData.organization} onChange={handleInputChange} />
                </div>
              </div>
              ...
              <div className="form-row">
                <div className="form-field-frame field-entry-name">
                  ...
                  <input type="text" name="work_title" className="form-input" placeholder="출품한 작품의 이름을 입력하세요" value={formData.work_title} onChange={handleInputChange} />
                </div>
                <div className="form-field-frame field-award-status">
                  ...
                  <div className="award-input-group">
                    <label className="radio-label">
                      <input type="radio" name="award" value="yes" checked={formData.is_awarded === true} onChange={handleAwardChange} />예
                    </label>
                    <label className="radio-label">
                      <input type="radio" name="award" value="no" checked={formData.is_awarded === false} onChange={handleAwardChange} />아니요
                    </label>
                    <input type="text" name="award_detail" className="form-input award-detail-input" placeholder="수상 내역을 입력하세요" value={formData.award_detail} onChange={handleInputChange} disabled={!formData.is_awarded} />
                  </div>
                </div>
              </div>
              ...
              <div className="form-row">
                <div className="form-field-frame field-participation-type">
                  ...
                  <div className="award-input-group">
                    <label className="radio-label">
                      <input type="radio" name="participation" value="team" checked={formData.participation_type === "team"} onChange={handleParticipationChange} />팀
                    </label>
                    <label className="radio-label">
                      <input type="radio" name="participation" value="individual" checked={formData.participation_type === "individual"} onChange={handleParticipationChange} />개인
                    </label>
                  </div>
                </div>
              </div>
