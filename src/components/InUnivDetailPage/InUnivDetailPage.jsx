...
const InUnivDetailPage = () => {
  ...
  const handleAddNote = () => {
    ...
    setNotes([...notes, { id: Date.now(), date: dateString, text: "" }]);
  };
    ...
    <div className="project-detail-container">
        ...
        <div className="detail-main-box">
          ...
          <div className="detail-header">
            <div className="breadcrumb">
              <span className="breadcrumb-item">교내활동</span>
            </div>
          ...
          <div className="info-grid">
            <div className="info-row">
              <span className="info-label">주관 부서</span>
              <span className="info-value">{activityData.organization || activityData.host || "-"}</span>
            </div>
            <div className="info-row">
            ...
            <div className="info-row">
              <span className="info-label">활동 기간</span>
          ...
          <div className="activity-section">
            ...
            {subActivities.length > 0 ? (
              <div className="sub-activities-list">
                ...
                <button className="add-activity-btn-inline" onClick={handleAddActivity}>
                  + 활동 추가하기
                </button>
              </div>
            ) : (
              <div className="activity-placeholder">
                ...
                <p className="placeholder-subtext">이 경험의 활동을 등록해보세요</p>
          ...
          <div className="detail-section">
            ...
            {activityData.task_detail && (
              <div className="detail-block">
                ...
                <p className="detail-block-content">{activityData.task_detail}</p>
              </div>
            )}
            ...
            {activityData.action_detail && (
              <div className="detail-block">
                ...
                <p className="detail-block-content">{activityData.action_detail}</p>
              </div>
            )}
            ...
            {activityData.result_detail && (
              <div className="detail-block">
                ...
                <p className="detail-block-content">{activityData.result_detail}</p>
              </div>
            )}
          ...
          {activityData.link_url && (
            <div className="links-section">
              ...
              <div className="link-item">
                ...
                <a href={activityData.link_url} target="_blank" rel="noopener noreferrer" className="link-url">
                  {activityData.link_url}
                </a>
              </div>
            </div>
      ...
      <div className="right-sidebar">
        ...
        <div className="notes-list">
          {notes.map((note) => (
            <div key={note.id} className="note-item">
              <div className="note-header">
                ...
                <button className="note-delete-btn" onClick={() => handleDeleteNote(note.id)} title="삭제">✕</button>
              </div>
              <textarea
          ...
          <button className="add-note-btn" onClick={handleAddNote}>+ 메모 추가하기</button>
        </div>
      </div>
    </div>
  );
...
export default InUnivDetailPage;